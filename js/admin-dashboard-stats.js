(function () {
  const ICONS = {
    students: '<svg viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3 1 8l11 5 9-4.09V17h2V8L12 3Z" fill="currentColor"/><path d="M5 10.18v4.7c0 .5.24.97.66 1.25C7.05 17.05 9.4 18 12 18s4.95-.95 6.34-1.87c.42-.28.66-.75.66-1.25v-4.7l-7 3.18-7-3.18Z" fill="currentColor"/></svg>',
    teachers: '<svg viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 4h13a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H8l-4 3V4Z" fill="currentColor"/><path d="M8.5 9.5h7M8.5 12.5h4.5" stroke="#fff" stroke-width="1.4" stroke-linecap="round"/><circle cx="19" cy="16.5" r="3.5" fill="currentColor"/><path d="M19 15v1.6l1.1.9" stroke="#fff" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    quizzes: '<svg viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="5" y="3" width="14" height="18" rx="2.5" fill="currentColor"/><rect x="8.5" y="1.5" width="7" height="3.5" rx="1.2" fill="currentColor"/><path d="M8 10.2h8M8 13.4h8M8 16.6h5" stroke="#fff" stroke-width="1.4" stroke-linecap="round"/></svg>',
    submissions: '<svg viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="12" width="4" height="8" rx="1" fill="currentColor"/><rect x="10" y="7" width="4" height="13" rx="1" fill="currentColor"/><rect x="16" y="3" width="4" height="17" rx="1" fill="currentColor"/></svg>',
    activity: '<svg viewBox="0 0 1 1" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3.5" y="4.5" width="17" height="16" rx="2.5" fill="currentColor"/><path d="M3.5 9h17" stroke="#fff" stroke-width="1.4"/><path d="M8 3v3M16 3v3" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M7 14.5l2.4 2.4L17 9.3" stroke="#fff" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>'
  };
